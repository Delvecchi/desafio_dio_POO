...
public class Dev {
    ...
    public void insceverBootcamp(Bootcamp bootcamp) {
        this.conteudosInscritos.addAll(bootcamp.getConteudos()); //pega o que tem no Set bootcamp e coloca em cursosIscritos
        bootcamp.getDevsInscritos().add(this);
    }

    public void progredir(){
        Optional<Conteudo> conteudo = this.conteudosInscritos.stream().findFirst(); //pegando primeiro conteudo, Optional serve para resolver retornos null
